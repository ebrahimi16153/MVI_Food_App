package com.github.ebrahimi16153.mvifoodapp.data.model
...
data class FoodList(
    ...
    data class Meal(
        ...
        fun toIngredient(): String {
            ...
            return ingredient.trim().replace("null", "").trim()
                .replace("\n+".toRegex(), replacement = "\n")
        }
        ...
        fun toMeasure(): String {
            ...
            return measure.trim().replace("null", "").trim()
                .replace("\n+".toRegex(), replacement = "\n")
